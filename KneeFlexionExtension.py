...
class KneeFlexionExtension(Exercise):
    def __init__(self):
        super().__init__()
        self.state_machine = ExerciseStateMachine("Knee Flexion Extension", "knee", 30, 10)  # Eşik değerleri ayarlanır
